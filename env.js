 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.zamazon.staging
 */

const BUNDLE_ID = 'com.zamazon'; // ios bundle id
const PACKAGE = 'com.zamazon'; // android package name
const NAME = 'Zamazon'; // app name
